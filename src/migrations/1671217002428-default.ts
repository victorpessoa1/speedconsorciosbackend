...
export class default1671217002428 implements MigrationInterface {
    name = 'default1671217002428'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "DadosBancarios" ("cliente_uuid" uuid NOT NULL, "CC" text NOT NULL, "CP" text NOT NULL, "Agencia" integer NOT NULL, CONSTRAINT "PK_8d68ab1a6a83c8ddee56154a97e" PRIMARY KEY ("cliente_uuid"))`);
        ...
        await queryRunner.query(`ALTER TABLE "DadosBancarios" ADD CONSTRAINT "FK_8d68ab1a6a83c8ddee56154a97e" FOREIGN KEY ("cliente_uuid") REFERENCES "clientes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "DadosBancarios" DROP CONSTRAINT "FK_8d68ab1a6a83c8ddee56154a97e"`);
        ...
        await queryRunner.query(`DROP TABLE "DadosBancarios"`);
